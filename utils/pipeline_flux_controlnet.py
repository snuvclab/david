    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if i < 12: new_controlnet_conditioning_scale = controlnet_conditioning_scale
                else: new_controlnet_conditioning_scale = 0.0
                ...
                if isinstance(controlnet_keep[i], list):
                    cond_scale = [c * s for c, s in zip(new_controlnet_conditioning_scale, controlnet_keep[i])]
                else:
                    controlnet_cond_scale = new_controlnet_conditioning_scale
