...
from imports.genpose.networks.gf_algorithms.losses_RT_sequence import loss_fn, loss_fn_edm
from imports.genpose.networks.gf_algorithms.sde import init_sde
from imports.genpose.networks.posenet_RT_sequence import GFObjectPose
...
class PoseNet(nn.Module):
    ...
    def save_ckpt(self, name=None):
        ...
        print(model_state_dict['theta_encoder.theta_encoder.0.weight'].shape)
        torch.save({
