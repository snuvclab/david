...
from imports.genpose.networks.pts_encoder.pointnet2_utils.pointnet2.pointnet2_modules import PointnetFPModule, PointnetSAModuleMSG
import imports.genpose.networks.pts_encoder.pointnet2_utils.pointnet2.pytorch_utils as pt_utils
...
class ThetaEncoder(nn.Module):
    def __init__(self, theta_dim=21*3, out_dim=512):
        super().__init__()
    ...
    def forward(self, x):
        # print(f"x.shape: {x.shape}") # 192 x 63
