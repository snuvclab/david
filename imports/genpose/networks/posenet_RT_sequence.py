...
from imports.genpose.networks.gf_algorithms.samplers_RT_sequence import cond_ode_likelihood, cond_ode_sampler, cond_pc_sampler, cond_ode_sampler_for_RT, cond_ode_sampler_for_RT_inference
# from imports.genpose.networks.gf_algorithms.samplers import cond_ode_likelihood, cond_pc_sampler, cond_ode_sampler_for_RT
from imports.genpose.networks.gf_algorithms.scorenet_RT_sequence import PoseScoreNet, PoseDecoderNet
...
class GFObjectPose(nn.Module):
    def __init__(self, cfg, prior_fn, marginal_prob_fn, sde_fn, sampling_eps, T):
        ...
        ''' encode theta '''
        self.theta_encoder = ThetaEncoder(theta_dim=120 * 21 * 3, out_dim=2048) # SMPLX theta dimension
