...
SMPL_MODEL_DIR = "./imports/mdm/body_models/"
GMM_MODEL_DIR = "./imports/mdm/visualize/joints2smpl/smpl_models/"
SMPL_MEAN_FILE = "./imports/mdm/visualize/joints2smpl/smpl_models/neutral_smpl_mean_params.h5"
# for collsion 
Part_Seg_DIR = "./imports/mdm/visualize/joints2smpl/smpl_models/smplx_parts_segm.pkl"