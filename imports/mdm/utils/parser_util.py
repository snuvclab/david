...
def add_training_options(parser):
    ...
    group.add_argument("--save_dir", required=False, type=str, help="Path to save checkpoints and results.")
    ...
    group.add_argument("--resume_checkpoint", default="imports/mdm/checkpoints/humanml_enc_512_50steps/model000750000.pt", type=str,
...
def add_generate_options(parser):
    ...
    group.add_argument("--motion_length", default=7.5, type=float,
