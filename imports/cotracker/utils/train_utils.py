...
from imports.cotracker.datasets.utils import collate_fn, collate_fn_train
from torch.utils.tensorboard import SummaryWriter
from imports.cotracker.datasets.dr_dataset import DynamicReplicaDataset
from imports.cotracker.models.evaluation_predictor import EvaluationPredictor
...
def get_eval_dataloader(dataset_root, ds_name):
    from imports.cotracker.datasets.tap_vid_datasets import TapVidDataset
    ...
    if ds_name == "dynamic_replica":
        ...
        from imports.cotracker.datasets.kubric_movif_dataset import KubricMovifDataset
...
def get_train_dataset(args):
    ...
    if "kubric" in args.train_datasets:
        from imports.cotracker.datasets import kubric_movif_dataset
