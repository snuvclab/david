import torch
from imports.hmr4d.network.hmr2.hmr2 import HMR2
from pathlib import Path
from imports.hmr4d.network.hmr2.configs import get_config
from imports.hmr4d import PROJ_ROOT

HMR2A_CKPT = PROJ_ROOT / f"hmr4d/inputs/checkpoints/hmr2/epoch=10-step=25000.ckpt"  # this is HMR2.0a, follow WHAM
