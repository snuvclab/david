...
from imports.hmr4d.utils.eval.eval_utils import (
...
from imports.hmr4d.utils.wis3d_utils import make_wis3d, add_motion_as_lines, get_colors_by_conf
from imports.hmr4d.utils.vis.renderer import Renderer, get_global_cameras_static, get_ground_params_from_points
from imports.hmr4d.utils.geo.hmr_cam import estimate_focal_length
from imports.hmr4d.utils.video_io_utils import read_video_np, save_video, get_writer
import imageio
...
from imports.hmr4d.utils.net_utils import repeat_to_max_len, gaussian_smooth
from imports.hmr4d.utils.geo.hmr_global import rollout_vel, get_static_joint_mask
...
class MetricMocap(pl.Callback):
    def __init__(self):
        ...
        self.J_regressor = torch.load("imports/hmr4d/utils/body_model/smpl_neutral_J_regressor.pt")
