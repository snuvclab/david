...
from imports.hmr4d.configs import MainStore, builds
from imports.hmr4d.utils.pylogger import Log
from imports.hmr4d.utils.comm.gather import all_gather
from imports.hmr4d.utils.eval.eval_utils import compute_camcoord_metrics, as_np_array
from imports.hmr4d.utils.smplx_utils import make_smplx
from imports.hmr4d.utils.vis.cv2_utils import cv2, draw_bbx_xys_on_image_batch, draw_coco17_skeleton_batch
from imports.hmr4d.utils.vis.renderer_utils import simple_render_mesh_background
from imports.hmr4d.utils.video_io_utils import read_video_np, get_video_lwh, save_video
from imports.hmr4d.utils.geo_transform import apply_T_on_points
from imports.hmr4d.utils.seq_utils import rearrange_by_mask
...
class MetricMocap(pl.Callback):
    def __init__(self):
        ...
        self.J_regressor = torch.load("imports/hmr4d/utils/body_model/smpl_3dpw14_J_regressor_sparse.pt").to_dense()
        self.J_regressor24 = torch.load("imports/hmr4d/utils/body_model/smpl_neutral_J_regressor.pt")
        self.smplx2smpl = torch.load("imports/hmr4d/utils/body_model/smplx2smpl_sparse.pt")
