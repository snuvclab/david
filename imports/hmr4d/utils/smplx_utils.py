...
from imports.hmr4d.utils.body_model import BodyModelSMPLH, BodyModelSMPLX
from imports.hmr4d.utils.body_model.smplx_lite import SmplxLiteCoco17, SmplxLiteV437Coco17, SmplxLiteSmplN24
from imports.hmr4d import PROJ_ROOT
...
def make_smplx(type="neu_fullpose", **kwargs):
    if type == "neu_fullpose":
        model = smplx.create(
            model_path="imports/hmr4d/inputs/models/smplx/SMPLX_NEUTRAL.npz", use_pca=False, flat_hand_mean=True, **kwargs
        )
        ...
        model = BodyModelSMPLX(model_path=PROJ_ROOT / "hmr4d/inputs/checkpoints/body_models", **bm_kwargs)
        ...
        bm_kwargs.update(kwargs)
        model = BodyModelSMPLX(model_path="imports/hmr4d/inputs/checkpoints/body_models", **bm_kwargs)
        ...
        model = BodyModelSMPLH(model_path="imports/hmr4d/inputs/checkpoints/body_models", **bm_kwargs)

    elif type in ["smplx-circle", "smplx-groundlink"]:
        # don't use hand
        bm_kwargs = {
            "model_path": "imports/hmr4d/inputs/checkpoints/body_models",
            "model_type": "smplx",
        ...
        bm_kwargs = {
            "model_path": "imports/hmr4d/inputs/checkpoints/body_models/smplx",
            "gender": kwargs.get("gender"),
            "num_betas": 10,
            "num_expression": 10,
        }
        ...
        bm_kwargs = {
            "model_path": PROJ_ROOT / "hmr4d/inputs/checkpoints/body_models",
            "model_type": "smpl",
            "gender": "neutral",
            "num_betas": 10,
            "create_body_pose": False,
