...
from imports.hmr4d.utils.geo.quaternion import qbetween
...
def triangulate_point(Ts_w2c, c_p2d, **kwargs):
    from imports.hmr4d.utils.geo.triangulation import triangulate_persp

    print("Deprecated, please import from imports.hmr4d.utils.geo.triangulation")
    return triangulate_persp(Ts_w2c, c_p2d, **kwargs)


def triangulate_point_ortho(Ts_w2c, c_p2d, **kwargs):
    from imports.hmr4d.utils.geo.triangulation import triangulate_ortho
