...
import numpy as np
from imports.hmr4d.utils.preproc.vitpose_pytorch import build_model
from imports.hmr4d.utils.preproc.vitfeat_extractor import get_batch
from tqdm import tqdm

from imports.hmr4d.utils.kpts.kp2d_utils import keypoints_from_heatmaps
from imports.hmr4d.utils.geo_transform import cvt_p2d_from_pm1_to_i
from imports.hmr4d.utils.geo.flip_utils import flip_heatmap_coco17


class VitPoseExtractor:
    def __init__(self, tqdm_leave=True):
        ckpt_path = "imports/hmr4d/inputs/checkpoints/vitpose/vitpose-h-multi-coco.pth"
