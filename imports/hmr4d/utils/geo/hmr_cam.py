import torch
import numpy as np
from imports.hmr4d.utils.geo_transform import project_p2d, convert_bbx_xys_to_lurb, cvt_to_bi01_p2d
...
def safely_render_x3d_K(x3d, K_fullimg, thr):
    ...
    if (x3d_unsafe_mask).sum() > 0:
        ...
        if False:
            from imports.hmr4d.utils.wis3d_utils import make_wis3d
